...
namespace MetadataExtractor.Formats.Mlv
{
    ...
    public sealed class MlvVersionDirectory : Directory
    {
        ...
        public MlvVersionDirectory()
        {
            SetDescriptor(new TagDescriptor<MlvVersionDirectory>(this));
        }

        public override string Name => "Magic Lantern Version";
